   ...
   public class RegexHelper
    {
        ...
        public static string ComPattern = "^[C|c][O|o][M|m][1-9]{1}$";
        ...
        {
            return Match(inputStr, patternStr, ifIgnoreCase, ifValidateWhiteSpace);
        }
        ...
        /// <param name="ifValidateWhiteSpace">是否验证空白字符串</param>
        /// <returns>是否匹配</returns>
        public static bool Match(string inputStr, string patternStr, bool ifIgnoreCase, bool ifValidateWhiteSpace)
        {

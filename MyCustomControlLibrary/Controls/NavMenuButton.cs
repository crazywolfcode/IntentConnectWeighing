...
namespace MyCustomControlLibrary
{
    public partial class NavMenuButton : RadioButton
    {
        ...
        public bool IsShowIage
        {
            get { return (bool)GetValue(IsShowIageProperty); }
            set { SetValue(IsShowIageProperty, value); }
        }

        public static readonly DependencyProperty IsShowIageProperty =
            DependencyProperty.Register("IsShowIage", typeof(bool), typeof(NavMenuButton), new PropertyMetadata(true));
